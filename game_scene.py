    ...
    def update(self, delta):
        ...
        if (self.player_projectile_cooldown < 0.0):
            ...
            if self.player.status == 0:
                self.player_projectiles.append(Projectile(self.player.position[0], self.player.position[1]+28, 400.0, 0.0, self.sprite_bullet))
                self.player_projectiles.append(Projectile(self.player.position[0], self.player.position[1]+36, 400.0, 0.0, self.sprite_bullet))
            ...
            if self.player.status == 2:
                self.player_projectiles.append(Projectile(self.player.position[0], self.player.position[1]+32, 600.0, 300.0, self.sprite_bullet))
                self.player_projectiles.append(Projectile(self.player.position[0], self.player.position[1]+32, 600.0, 150.0, self.sprite_bullet))
                self.player_projectiles.append(Projectile(self.player.position[0], self.player.position[1]+32, 600.0, 0.0, self.sprite_bullet))
                self.player_projectiles.append(Projectile(self.player.position[0], self.player.position[1]+32, 600.0, -150.0, self.sprite_bullet))
                self.player_projectiles.append(Projectile(self.player.position[0], self.player.position[1]+32, 600.0, -300.0, self.sprite_bullet))
